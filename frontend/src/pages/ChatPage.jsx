  ...
  return (
    <div className="w-full bg-gray-100 min-h-screen mt-[64px]">
      ...
      <div className="bg-orange-500 w-full">
        <div className="max-w-5xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-lg font-extrabold text-white tracking-tight">Negotiation Chat</h1>
      ...
      <div className="max-w-5xl mx-auto px-4 py-5">
        ...
        {error && (
          <div className="mb-4 px-4 py-3 bg-white border-l-4 border-red-500 shadow-sm text-sm text-red-500 font-medium">
            {error}
          </div>
        )}
        ...
        <div className="flex flex-col lg:flex-row gap-4 items-start">
          ...
          {/* ── LEFT: Item Card ── */}
          <div className="w-full lg:w-64 flex-shrink-0 bg-white shadow-sm">
          ...
          {/* ── RIGHT: Chat ── */}
          <div className="flex-1 flex flex-col bg-white shadow-sm overflow-hidden" style={{ height: "600px" }}>
